...
func New(reg registry.Registry, security iamv1.API) *gateway {
	return &gateway{registry: reg, selector: registry.NewSelector(), security: security}
}

func (g *gateway) RefreshRoutes(ctx context.Context) error { return g.refreshRoutes(ctx) }
