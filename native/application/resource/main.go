...
import (
	...
	"github.com/gcc798/microservice-kit/application/resource/internal/bootstrap"
...
func run() (err error) {
	...
	cfg, _, err := serviceconfig.Load("application/resource")
	if err != nil {
		return err
	}
	...
	shutdownTelemetry, err := telemetry.Init(ctx, string(sharedconfig.ServiceResource), cfg.Service.ID, sharedconfig.CurrentEnv())
	if err != nil {
		return err
	}
	defer func() {
